...
#define SECTOR_SIZE_TO_MB(capacity)                                            \
	((capacity) * DISK_SECTOR_SIZE / 1024 / 1024)
#define SECTOR_SIZE_TO_GB(capacity)                                            \
	((capacity) * DISK_SECTOR_SIZE / 1024 / 1024 / 1024)
